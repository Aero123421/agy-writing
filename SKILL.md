...
3. Run from the relevant project directory with `agy --mode=accept-edits --model "<MODEL_ID>" --print-timeout 10m --print "<PROMPT>"`; quote multiline or user-supplied text safely, and never add `--dangerously-skip-permissions`.
